...
@section('content')
        ...
        <div class="container">
            <div class="agile_ab_w3ls_info">
                <div class="col-md-6 ab_pic_w3ls">
                    <img src="{{ asset('img/elite-shop/ab_pic.jpg') }}" alt=" " class="img-responsive" />
                </div>
            ...
            <div class="banner_bottom_agile_info_inner_w3ls">
                <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
                    <figure class="effect-roxy">
                        <img src="{{ asset('img/elite-shop/bottom1.jpg') }}" alt=" " class="img-responsive" />
                        <figcaption>
                ...
                <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
                    <figure class="effect-roxy">
                        <img src="{{ asset('img/elite-shop/bottom2.jpg') }}" alt=" " class="img-responsive" />
                        <figcaption>
                            <h3><span>F</span>all Ahead</h3>
                            <p>New Arrivals</p>
                        </figcaption>
            ...
            <div class="inner_w3l_agile_grids">
                <div class="col-md-3 team-grids">
                    <div class="thumbnail team-w3agile">
                        <img src="{{ asset('img/elite-shop/t1.jpg') }}" class="img-responsive" alt="">
                ...
                <div class="col-md-3 team-grids">
                    <div class="thumbnail team-w3agile">
                        <img src="{{ asset('img/elite-shop/t2.jpg') }}" class="img-responsive" alt="">
                        <div class="social-icons team-icons right-w3l fotw33">
                            <div class="caption">
                                <h4>Anika Mollik</h4>
                                <p>Add Short Description</p>
                ...
                <div class="col-md-3 team-grids">
                    <div class="thumbnail team-w3agile">
                        <img src="{{ asset('img/elite-shop/t3.jpg') }}" class="img-responsive" alt="">
                        <div class="social-icons team-icons right-w3l fotw33">
                            <div class="caption">
                                <h4>Megali Deo</h4>
                                <p>Add Short Description</p>
                ...
                <div class="col-md-3 team-grids">
                    <div class="thumbnail team-w3agile">
                        <img src="{{ asset('img/elite-shop/t4.jpg') }}" class="img-responsive" alt="">
                        <div class="social-icons team-icons right-w3l fotw33">
                            <div class="caption">
                                <h4>Retas Word</h4>
                                <p>Add Short Description</p>
    ...
    <div class="schedule-bottom">
        <div class="col-md-6 agileinfo_schedule_bottom_left">
            <img src="{{ asset('img/elite-shop/mid.jpg') }}" alt=" " class="img-responsive" />
        </div>
        ...
        <div class="container">
            ...
            <div class="col-md-7 bb-grids bb-middle-agileits-w3layouts">
                <div class="bb-middle-agileits-w3layouts grid">
                    <figure class="effect-roxy">
                        <img src="{{ asset('img/elite-shop/bottom3.jpg') }}" alt=" " class="img-responsive" />
                        <figcaption>
                            <h3><span>S</span>ale </h3>
                            <p>Upto 55%</p>
                        </figcaption>
                ...
                <div class="bb-middle-agileits-w3layouts forth grid">
                    <figure class="effect-roxy">
                        <img src="{{ asset('img/elite-shop/bottom4.jpg') }}" alt=" " class="img-responsive">
                        <figcaption>
                            <h3><span>S</span>ale </h3>
                            <p>Upto 65%</p>
                        </figcaption>
