            ...
            <div class="span9">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('product.detail') }}"><img alt="" src="themes/images/ladies/9.jpg"></a></td>
                    ...
                    <tr>
                        <td><input type="checkbox" value="option1"></td>
                        <td><a href="{{ route('product.detail') }}"><img alt="" src="themes/images/ladies/1.jpg"></a></td>
                    ...
                    <tr>
                        <td><input type="checkbox" value="option1"></td>
                        <td><a href="{{ route('product.detail') }}"><img alt="" src="themes/images/ladies/3.jpg"></a></td>
