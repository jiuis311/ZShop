    ...
    <div class="header-bot_inner_wthreeinfo_header_mid">
        <div class="col-md-4 header-middle">
            <form action="#" method="post">
                <input type="search" name="search" placeholder="Coming soon function..." required="">
        ...
        <div class="col-md-4 logo_agile">
            <h1><a href="{{ route('home') }}"><span>Z</span> Shop <i class="fa fa-shopping-bag top_logo_agile_bag" aria-hidden="true"></i></a></h1>
        </div>
        <!-- header-bot -->
